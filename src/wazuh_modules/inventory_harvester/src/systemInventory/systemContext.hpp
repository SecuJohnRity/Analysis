...
public:
    ...
    std::string_view groupId() const // Corresponds to GID
    {
        if (m_type == VariantType::Delta)
        {
    ...
    std::string_view groupUsers() const // Returns a string, might need parsing for array
    {
        if (m_type == VariantType::Delta)
        {
    ...
    std::string_view userId() const // Corresponds to UID
    {
        if (m_type == VariantType::Delta)
        {
    ...
    std::string_view userGroupId() const // Corresponds to GID
    {
        if (m_type == VariantType::Delta)
        {
    ...
    std::string_view userRoles() const // Returns a string, might need parsing for array
    {
        if (m_type == VariantType::Delta)
        {
    ...
    std::string_view userGroups() const // Returns a string, might need parsing for array
    {
        if (m_type == VariantType::Delta)
        {
    ...
    std::string_view userItemId() const
    {
        ...
        {
            // Assuming item_id might come from JSON for delete operations specifically
            if (m_jsonData && m_jsonData->contains("/data/item_id"_json_pointer))
            {
                // Ensure this is only for user-related JSON actions if possible,
                // or rely on m_affectedComponentType being set correctly before calling this.
